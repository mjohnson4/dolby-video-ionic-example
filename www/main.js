...
const routes = [
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_dolby-poc_dolby-poc_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./dolby-poc/dolby-poc.module */ 2003)).then(m => m.DolbyPocPageModule)
    }
];
